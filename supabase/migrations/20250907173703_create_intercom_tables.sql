...
CREATE INDEX idx_intercom_actions_user_id ON intercom_actions(user_id);
CREATE INDEX idx_intercom_actions_created_at ON intercom_actions(created_at DESC);
CREATE INDEX idx_intercom_status_updated_at ON intercom_status(updated_at DESC);
